...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.getProductById = function (id) {
        var _this = this;
        var observable = this._httpService.getProductIdFromServer(id);
        observable.subscribe(function (data) {
            _this.product = data;
        });
    };
    EditComponent.prototype.editProduct = function (id) {
        var _this = this;
        var observable = this._httpService.editProductInServer(id, this.product);
        observable.subscribe(function (data) {
            if (!data.hasErrors) {
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getProductsFromServer = function () {
        return this._http.get("http://localhost:8000/getProducts");
    };
    HttpService.prototype.getProductIdFromServer = function (id) {
        return this._http.get("http://localhost:8000/getOneProduct/" + id);
    };
    HttpService.prototype.addProductInServer = function (product) {
        return this._http.post("http://localhost:8000/newProduct", product);
    };
    HttpService.prototype.editProductInServer = function (id, product) {
        return this._http.put("http://localhost:8000/editProduct/" + id, product);
    };
    HttpService.prototype.deleteProductInServer = function (id) {
...
var ListComponent = /** @class */ (function () {
    function ListComponent(_httpService, _route, _router) {
        this._httpService = _httpService;
        this._route = _route;
        this._router = _router;
        this.products = [];
    ...
    ListComponent.prototype.getProducts = function () {
        var _this = this;
        var observable = this._httpService.getProductsFromServer();
        observable.subscribe(function (data) {
            _this.products = data;
        });
    };
    ListComponent.prototype.deleteProduct = function (id) {
        var observable = this._httpService.deleteProductInServer(id);
        observable.subscribe(function (data) { });
        this.getProducts();
    };
...
var NewComponent = /** @class */ (function () {
    ...
    NewComponent.prototype.addProduct = function () {
        var _this = this;
        var observable = this._httpService.addProductInServer(this.product);
        observable.subscribe(function (data) {
            if (!data.hasErrors) {
                _this._router.navigate(['/list']);
            }
...
module.exports = __webpack_require__(/*! /Users/edwardshin/Documents/Github/coding_dojo/_week9/day40/Shin_Manager/public/src/main.ts */"./src/main.ts");
